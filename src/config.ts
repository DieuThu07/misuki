...
export const siteConfig: SiteConfig = {
	...
	font: {
		...
		asciiFont: {
			...
			fontFamily: "DarleySans-Regular",
			fontWeight: "400",
			localFonts: ["DarleySans-Regular.woff2"],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twiloo-orcin.vercel.app/",
		lang: SITE_LANG,
	},
};
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_113W21kgwFcjNMQn1fjluzH81ztI00gW", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="4585baba-8ed7-4c3a-8c58-c17df99977a0"></script>
