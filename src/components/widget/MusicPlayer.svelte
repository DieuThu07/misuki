...
const localPlaylist = [
	{
		id: 1,
		title: "Quên",
		artist: "Lil Liem, n0id",
		cover: "assets/music/cover/hitori.jpg",
		url: "https://files.catbox.moe/hy9f43.m4a",
		duration: 0,
	},
	{
		id: 2,
		title: "SET NHAC CHO CAC MY NHAN",
		artist: "Lucin3x",
		cover: "assets/music/cover/xryx.jpg",
		url: "https://files.catbox.moe/j3twru.m4a",
		duration: 0,
	},
	{
		id: 3,
		title: "Anh Đã Từng Cố Gắng",
		artist: "Qiz Remix",
		cover: "assets/music/cover/cl.jpg",
		url: "https://files.catbox.moe/03er01.wav",
		duration: 0,
	},
];
